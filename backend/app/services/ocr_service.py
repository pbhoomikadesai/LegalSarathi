...
# Dynamically resolve Python executable and site-packages path relative to backend folder
_base_dir = Path(__file__).resolve().parents[2]
_VENV_PYTHON = str(_base_dir / "venv" / "Scripts" / "python.exe")
_VENV_SITE = str(_base_dir / "venv" / "Lib" / "site-packages")
